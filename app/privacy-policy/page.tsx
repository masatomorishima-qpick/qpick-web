...
export default function PrivacyPolicyPage() {
  return (
    <div style={styles.container}>
      ...
      <p>Blue Adventures（以下「当社」といいます）は、当社が提供するサービス「Qpick」（以下「本サービス」といいます）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます）を定めます。</p>

      <section style={styles.section}>
        <h2 style={styles.heading}>第1条（収集する情報）</h2>
        <p>当社は、本サービスの提供にあたり、以下の情報を取得する場合があります。</p>
        <ol style={styles.list}>
          <li><strong>位置情報：</strong>現在地周辺の店舗を検索するために、ユーザーの同意に基づいて位置情報（緯度・経度）を取得します。この情報は検索実行時のみ使用され、サーバー上に個人と紐づく形での長期保存は行いません。</li>
          <li><strong>端末情報・ログ情報：</strong>サービス改善のため、アクセスログ、検索キーワード、ブラウザの種類などの情報を収集します。</li>
          <li><strong>Cookieおよびローカルストレージ：</strong>不正な連続投稿の防止や、利便性向上のためにCookieやローカルストレージを使用します。</li>
        </ol>
      </section>
      ...
      <section style={styles.section}>
        ...
        <p style={styles.contact}>
          <strong>運営者：</strong>Blue Adventures<br />
          <strong>お問い合わせ：</strong><a href="mailto:info@blueadventures.jp">info@blueadventures.jp</a>
        </p>
      </section>
